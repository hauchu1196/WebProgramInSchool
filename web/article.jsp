            ...
            <div class="row">
                <div class="col-lg-offset-1 col-md-7">
                    <div class="nnt-title-main-post">
                        Thu sang, hãy thử "quên" lá vàng miền Bắc để về với miền Tây đón mùa nước nổi
                    </div>
                    <div class="nnt-inf-main-post">
                        ...
                        <span class="nnt-time-main-post">00:05 04/09/2017</span>
                    </div>
            ...
            <script>
                function initMap() {
                    var map = new google.maps.Map(document.getElementById('map'), {
                        ...
                        center: {lat: 20.9724404, lng: 105.83413530000007},
                        zoom: 13
                    });
                    ...
                    var destinationPos = new google.maps.LatLng(10.583714, 105.0598097);
