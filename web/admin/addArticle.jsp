            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div style="margin-bottom: 15px">
                        <input id="address" class="form-control" style="width:300px; display: inline-block" type="textbox" value="Hà nội">
                        <input id="lat" class="form-control" style="width:300px; display: inline-block" type="textbox" placeholder="lat">
                        <input id="long" class="form-control" style="width:300px; display: inline-block" type="textbox" placeholder="long">
                        <input id="submit" class="btn btn-default" type="button" value="Geocode">
                    </div>
                    <div id="map"></div>

                    <div class="text-center" style="margin-top: 5px">
                        <button class="btn btn-primary" id="addArticle">Add</button>
                    </div>
