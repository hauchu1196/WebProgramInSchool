    ...
    <head>
        ...
        <jsp:include page="layout/header.jsp"></jsp:include>
            ...
            <div class="hcv-body-content-area clearfix">
                <div class="hcv-xem-an-choi-topbg">
                    <div>
                        <span>Ăn uống</span>
                    </div>
                </div>
                ...
                <div class="col-md-10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <p class="hcv-tn-sapo">Vừa đẹp mắt lại vừa ngon "cạn lời", từ món nóng tới món lạnh,… bao nhiêu đây đủ để khiến bạn kích thích muốn xách ba lô và lên máy ...</p>
